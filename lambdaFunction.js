...
var questions = [
    {
        "Who won the 2015 NCAA Mens Basketball National Championship?": [
            "Duke",
            "Wisconsin",
            "NC State",
            "Oklahoma",
    ...
    {
        "Which season did the NCAA add the three point shot?": [
            "The 1986–87 season",
            "The 1983-84 season",
            "The 1981-82 season",
            "The 1988-89 season"
    ...
    {
        "What is the original length of the three point shot?": [
            "19 feet and 9 inches",
    ...
    {
        "Who won the 1938 Mens National Invitation Tournament?": [
            "Temple",
            "Kansas",
            "Indiana",
            "North Carolina"
    ...
    {
        "Who was the last NCAA Mens Basketball team to repeat winning the National Championship?": [
            "Florida",
            "Duke University",
            "Michigan State",
            "UNLV"
    ...
    {
        "Who was the coach for the team that won the 1983 NCAA Mens Basketball National Championship?": [
            "Jim Valvano",
            "Dean Smith",
            "Bob Knight",
            "Rollie Massimino"
    ...
    {
        "How many teams played in the 1970 NCAA Mens Basketball Tournament?": [
            "25",
            "32",
            "16",
            "24"
...
var ANSWER_COUNT = 4;
var GAME_LENGTH = 5;
var CARD_TITLE = "March Madness";

function getWelcomeResponse(callback) {
    var sessionAttributes = {},
        speechOutput = "March Madness. I will ask you " + GAME_LENGTH.toString()
